    ...
    <div class="item-table ">
      <div class="item-row">
        ...
        <div class="col col-check">  
          <i 
          :class="{'iconfont':true, 'icon-checkbox':true, 'icon-checkbox-selected':checked}"
          @click="changeChecked"
           >√</i> 
        </div>
        <!--商品图片展示-->
        <div class="col col-img">  
          <a href="//item.mi.com/1161800009.html" target="_blank"> 
            <img alt="" :src="option.img_url" height="80"> 
          </a> 
        </div>
        ...
        <div class="col col-num">  
          <div class="change-goods-num clearfix J_changeGoodsNum"> 
            ...
            <input tyep="text"  v-model="option.count"  autocomplete="off" class="goods-num J_goodsNum" />
        ...
        <!--小计-->
        <div class="col col-total"> {{smallprice}}元 <p class="pre-info">  </p> </div>
        <!--操作-->
...
<script>
  export default{
    data(){
      return {
        smallprice:this.option.price*this.option.count,
        checked:false
      }
    },
    props:{
